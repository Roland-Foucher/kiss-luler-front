                ...
                <div className="max-w-screen-xl px-2 py-10 mx-auto lg:items-center lg:flex">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <span className="sm:block">
                            ...
                            {/*ajout du uploader image*/}
                        </span>

                        <div className="mx-2 w-64 text-center "> 
                            <div className="relative w-22">
                                <img className="w-32 h-32 rounded-full absolute" src="https://images.pexels.com/photos/2690323/pexels-photo-2690323.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" />
