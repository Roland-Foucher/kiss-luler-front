...
export default function Banners() {
    return (
        <div className="px-4 py-3 text-black border-red-400 border-b">
            <div className="flex justify-center items-center ">
                ...
                <button className=" ml-4 w-20 rounded-md p-2 text-sm text-white hover:bg-gray-600 hover:duration-500 bg-gray-200 p-2">Créer</button>
            </div>
        </div>
    )
}