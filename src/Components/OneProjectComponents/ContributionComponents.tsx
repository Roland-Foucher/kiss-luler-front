...
export default function ContributionComponent({ item, isUser, setShowModalEditContribution, setEditConsideration, isActive }: Props) {
        ...
        <>
            ...
            >
                <section className="shadow-md border border-yellowBull p-8 bg-gray-100 rounded-lg"
                    style={{
                        backgroundColor: isActive ? 'rgb(134, 197, 134)' : ''
                    }}
                >
