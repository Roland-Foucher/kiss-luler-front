      ...
      <>
        ...
        >
          <div className="relative w-auto my-6 mx-auto max-w-3xl ">
            ...
            {/*content*/}
            <div className=" bg-neutral-100/80 border-x border-orangeBull rounded-sm shadow-lg relative flex flex-col w-full outline-none focus:outline-none">
              ...
              <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-md w-full space-y-8">
                  ...
                  <div>
                    ...
                    <h2 className="mt-4 text-center text-3xl font-light  text-red-500 tracking-widest">{form.title} </h2>
                  </div>
