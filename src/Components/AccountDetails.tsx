        ...
        >
          ...
          <div className="justify-between sm:flex my-8 ">
            ...
            <div className=" absolute  top-2 md:right-3  ">
              <button className='p-2 border-1 border-yellowBull rounded-md items-center inline-flex font-light hover:bg-yellowBull/20'>Modifier <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-4 ml-2 h-4 ml-2">
